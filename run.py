...
parser.add_argument('--validate',
                    help='Swith BIDS validation on/off.',
                    choices = ['true', 'false'],
                    default = 'true')
...
parser.add_argument('--3T',
                    ...
                    choices = ['true', 'false'],
                    default = 'true')
parser.add_argument('--signatures', help='Predictive morphological signatures to compute.',
                    choices=["none", "ctp"],
                    default=["ctp"],
                    nargs="+")
...
if args.analysis_level == "participant":
   ...
   print("Here comes the cpt calculation")
